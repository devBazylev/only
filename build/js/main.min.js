...
Object.defineProperty(exports, "__esModule", { value: true });
const info_1 = __webpack_require__(/*! ./modules/info */ "./js/modules/info.ts");
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.initInfo = void 0;
const swiper_1 = __webpack_require__(/*! swiper */ "./js/vendor/swiper/swiper.mjs");
const modules_1 = __webpack_require__(/*! swiper/modules */ "./js/vendor/swiper/modules/index.mjs");
const util_1 = __webpack_require__(/*! ../utils/util */ "./js/utils/util.ts");
const initInfo = () => {
    ...
    frames.forEach((frame) => {
        const frameEl = frame;
        const sliders = frameEl.querySelectorAll('.info__slider');
        const conts = frameEl.querySelectorAll('.info__cont');
        const frac = frameEl.querySelector('.info__frac--min');
        const prev = frameEl.querySelector('.info__btn--prev');
        const next = frameEl.querySelector('.info__btn--next');
        const minYear = frameEl.querySelector('.info__year--min');
        const maxYear = frameEl.querySelector('.info__year--max');
        const pag = frameEl.querySelector('.info__pag');
        const covers = Array.from((pag === null || pag === void 0 ? void 0 : pag.querySelectorAll('.info__cover')) || []);
        const bullets = Array.from((pag === null || pag === void 0 ? void 0 : pag.querySelectorAll('.info__bullet')) || []);
        ...
        const recalcYears = () => {
            const contActive = frameEl.querySelector(`.info__cont--${i}`);
            if (!contActive)
                return;
            ...
            const animateMin = () => {
                if (min < minNew) {
                    min++;
                    if (minYear)
                        minYear.textContent = String(min);
            ...
            const animateMax = () => {
                if (max < maxNew) {
                    max++;
                    if (maxYear)
                        maxYear.textContent = String(max);
        ...
        const onPrevDebounced = (0, util_1.debounce)(() => {
            if (i > 0) {
                const oldId = i;
                i--;
        ...
        const onNextDebounced = (0, util_1.debounce)(() => {
            if (i < iMax - 1) {
                const oldId = i;
                i++;
                activateBullet(oldId);
        ...
        util_1.desk.addEventListener('change', onDesk);
        sliders.forEach((slider) => {
            const cont = slider.closest('.info__cont');
            // eslint-disable-next-line
            new swiper_1.Swiper(slider, {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.debounce = exports.desk = void 0;
...
/***/ "./js/vendor/swiper/modules/index.mjs":
/*!********************************************!*\
  !*** ./js/vendor/swiper/modules/index.mjs ***!
  \********************************************/
/*! exports provided: Navigation, Pagination */
/***/ (function(__webpack_module__, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _navigation_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./navigation.mjs */ "./js/vendor/swiper/modules/navigation.mjs");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Navigation", function() { return _navigation_mjs__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _pagination_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pagination.mjs */ "./js/vendor/swiper/modules/pagination.mjs");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Pagination", function() { return _pagination_mjs__WEBPACK_IMPORTED_MODULE_1__["default"]; });
...
/***/ "./js/vendor/swiper/modules/navigation.mjs":
/*!*************************************************!*\
  !*** ./js/vendor/swiper/modules/navigation.mjs ***!
  \*************************************************/
...
/* harmony import */ var _shared_create_element_if_not_defined_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../shared/create-element-if-not-defined.mjs */ "./js/vendor/swiper/shared/create-element-if-not-defined.mjs");
/* harmony import */ var _shared_utils_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../shared/utils.mjs */ "./js/vendor/swiper/shared/utils.mjs");
...
/***/ "./js/vendor/swiper/modules/pagination.mjs":
/*!*************************************************!*\
  !*** ./js/vendor/swiper/modules/pagination.mjs ***!
  \*************************************************/
/*! exports provided: default */
...
/* harmony import */ var _shared_classes_to_selector_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../shared/classes-to-selector.mjs */ "./js/vendor/swiper/shared/classes-to-selector.mjs");
/* harmony import */ var _shared_create_element_if_not_defined_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../shared/create-element-if-not-defined.mjs */ "./js/vendor/swiper/shared/create-element-if-not-defined.mjs");
/* harmony import */ var _shared_utils_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../shared/utils.mjs */ "./js/vendor/swiper/shared/utils.mjs");
...
/***/ "./js/vendor/swiper/shared/classes-to-selector.mjs":
/*!*********************************************************!*\
  !*** ./js/vendor/swiper/shared/classes-to-selector.mjs ***!
  \*********************************************************/
/*! exports provided: c */
...
/***/ "./js/vendor/swiper/shared/create-element-if-not-defined.mjs":
/*!*******************************************************************!*\
  !*** ./js/vendor/swiper/shared/create-element-if-not-defined.mjs ***!
  \*******************************************************************/
/*! exports provided: c */
...
/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils.mjs */ "./js/vendor/swiper/shared/utils.mjs");
...
/***/ "./js/vendor/swiper/shared/ssr-window.esm.mjs":
/*!****************************************************!*\
  !*** ./js/vendor/swiper/shared/ssr-window.esm.mjs ***!
  \****************************************************/
...
/***/ "./js/vendor/swiper/shared/swiper-core.mjs":
/*!*************************************************!*\
  !*** ./js/vendor/swiper/shared/swiper-core.mjs ***!
  \*************************************************/
...
/* harmony import */ var _ssr_window_esm_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ssr-window.esm.mjs */ "./js/vendor/swiper/shared/ssr-window.esm.mjs");
/* harmony import */ var _utils_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils.mjs */ "./js/vendor/swiper/shared/utils.mjs");
...
/***/ "./js/vendor/swiper/shared/utils.mjs":
/*!*******************************************!*\
  !*** ./js/vendor/swiper/shared/utils.mjs ***!
  \*******************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _shared_swiper_core_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shared/swiper-core.mjs */ "./js/vendor/swiper/shared/swiper-core.mjs");
